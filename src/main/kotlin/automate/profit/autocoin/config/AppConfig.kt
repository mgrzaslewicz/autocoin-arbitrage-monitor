...
data class AppConfig(
        ...
        val exchangesToMonitorTwoLegArbitrageOpportunities: List<SupportedExchange> = getPropertyThenEnv("APP_EXCHANGES_TO_MONITOR_TWO_LEG_ARBITRAGE_OPPORTUNITIES", "bibox,binance,bitbay,bitmex,bitstamp,bittrex,bleutrade,cexio,coinbasepro,coinbene,exmo,gateio,gemini,hitbtc,kraken,kucoin,livecoin,luno,poloniex")
                .split(",")
