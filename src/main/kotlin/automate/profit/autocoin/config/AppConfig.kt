...
data class AppConfig(
        ...
        val orderBookUsdAmountThresholds: List<BigDecimal> = getPropertyThenEnv("APP_ORDER_BOOK_USD_AMOUNT_THRESHOLDS", "100.0,500.0,1000.0,2000.0").split(",").map { BigDecimal(it) }
)
